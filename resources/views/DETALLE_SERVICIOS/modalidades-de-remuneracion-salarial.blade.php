            ...
            <div class="bg-white rounded-2xl shadow-xl overflow-hidden" data-aos="fade-up">
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-0">
                    <div class="order-2 lg:order-1">
                        ...
                        <p class="text-gray-600 mb-6">Informes actualizados sobre normativas salariales</p>
                    ...
                    <div class="order-2 p-8 lg:p-12 flex flex-col justify-center">
                        <div class="prose prose-lg max-w-none text-gray-700">
                            <p class="mb-6"><strong>Informes legales actualizados sobre modalidades de remuneración salarial conforme a las últimas normativas.</strong></p>

                            <h3 class="text-2xl font-bold mb-4" style="color: #1F1E3A;">Nuestro servicio comprende:</h3>
                            <ul class="space-y-3 mb-6">
                                <li class="flex items-start">
                                    ...
                                    <span>Análisis de normativas salariales vigentes</span>
                                </li>
                                <li class="flex items-start">
                                    <svg class="w-6 h-6 mt-1 mr-3 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20" style="color: #1C6AB0;">
                                        <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"></path>
                                    </svg>
                                    <span>Modalidades de pago permitidas</span>
                                </li>
                                <li class="flex items-start">
                                    <svg class="w-6 h-6 mt-1 mr-3 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20" style="color: #1C6AB0;">
                                        <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"></path>
                                    </svg>
                                    <span>Estructuras salariales legales</span>
                                </li>
                                <li class="flex items-start">
                                    <svg class="w-6 h-6 mt-1 mr-3 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20" style="color: #1C6AB0;">
                                        <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"></path>
                                ...
                                <li class="flex items-start">
                                    ...
                                    <span>Optimización de cargas sociales</span>
                                </li>
                                <li class="flex items-start">
                                    <svg class="w-6 h-6 mt-1 mr-3 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20" style="color: #1C6AB0;">
                                        <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"></path>
                                    </svg>
                                    <span>Informes técnico-legales</span>
                                </li>
                            </ul>

                            <p class="text-base leading-relaxed"><strong>Aseguramos que sus políticas de remuneración cumplan con todas las disposiciones legales actualizadas.</strong></p>
                        </div>
                        <div class="mt-8">
