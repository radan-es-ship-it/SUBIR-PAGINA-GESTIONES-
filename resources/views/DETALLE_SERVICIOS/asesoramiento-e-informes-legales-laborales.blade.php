...
<section class="relative text-white py-24">
    ...
    <div class="container mx-auto px-4 relative z-10">
        <div class="max-w-4xl mx-auto" data-aos="fade-up">
            ...
            <p class="text-xl text-gray-300 leading-relaxed">{{ $servicio->descripcion }}</p>
        </div>
    </div>
</section>
            ...
            <div class="bg-white rounded-2xl shadow-xl overflow-hidden" data-aos="fade-up">
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-0">
                    <div class="order-2 lg:order-1">
                        ...
                        <p class="text-gray-600 mb-6">Video informativo sobre nuestro servicio de asesoramiento laboral</p>
                        <div class="relative rounded-xl overflow-hidden shadow-2xl bg-gray-900">
                            <video class="w-full aspect-video" controls poster="{{ asset('videos/thumbnail.jpg') }}">
                                <source src="{{ asset('videos/VIDEO DEL SISTEMA DE GESTIONES.mp4') }}" type="video/mp4">
                    ...
                    <div class="order-2 p-8 lg:p-12 flex flex-col justify-center">
                        <div class="prose prose-lg max-w-none text-gray-700">
                            <p class="mb-6"><strong>Asesoramiento profesional y elaboración de informes técnicos sobre la correcta aplicación de normativas laborales.</strong></p>

                            <h3 class="text-2xl font-bold mb-4" style="color: #1F1E3A;">Nuestros servicios:</h3>
                            <ul class="space-y-3 mb-6">
                                <li class="flex items-start">
                                    ...
                                    <span>Interpretación de normas laborales vigentes</span>
                                </li>
                                <li class="flex items-start">
                                    <svg class="w-6 h-6 mt-1 mr-3 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20" style="color: #1C6AB0;">
                                        <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"></path>
                                    </svg>
                                    <span>Elaboración de informes técnico-legales</span>
                                </li>
                                <li class="flex items-start">
                                    <svg class="w-6 h-6 mt-1 mr-3 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20" style="color: #1C6AB0;">
                                        <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"></path>
                                    </svg>
                                    <span>Análisis de casos específicos</span>
                                </li>
                                <li class="flex items-start">
                                    <svg class="w-6 h-6 mt-1 mr-3 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20" style="color: #1C6AB0;">
                                        <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"></path>
                                    </svg>
                                    <span>Recomendaciones de cumplimiento</span>
                                </li>
                                <li class="flex items-start">
                                    <svg class="w-6 h-6 mt-1 mr-3 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20" style="color: #1C6AB0;">
                                        <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"></path>
                                    </svg>
                                    <span>Actualización normativa permanente</span>
                                </li>
                                <li class="flex items-start">
                                    <svg class="w-6 h-6 mt-1 mr-3 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20" style="color: #1C6AB0;">
                                        <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"></path>
                                    </svg>
                                    <span>Capacitación en legislación laboral</span>
                                </li>
                                <li class="flex items-start">
                                    <svg class="w-6 h-6 mt-1 mr-3 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20" style="color: #1C6AB0;">
                                        <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"></path>
                                    </svg>
                                    <span>Auditoría de procedimientos</span>
                                </li>
                            </ul>

                            <p class="text-base leading-relaxed"><strong>Mantenemos su institución actualizada y en cumplimiento con todas las disposiciones legales laborales.</strong></p>
                        </div>
                        <div class="mt-8">
                            <div class="flex flex-col sm:flex-row gap-4">
                                <a href="{{ route('contacto.index') }}" class="btn-primary-lg flex-1 text-center">Solicitar este Servicio</a>
                                <a href="{{ route('servicios.index') }}" class="btn-secondary-lg flex-1 text-center">Ver Más Servicios</a>
                            </div>
                        </div>
                    </div>
                </div>
