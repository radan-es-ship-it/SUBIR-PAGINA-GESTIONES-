            ...
            <div class="bg-white rounded-2xl shadow-xl overflow-hidden" data-aos="fade-up">
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-0">
                    ...
                    <div class="order-2 lg:order-1">
                        ...
                        <p class="text-gray-600 mb-6">Orientación especializada para denuncias contra funcionarios</p>
                        ...
                        <div class="relative rounded-xl overflow-hidden shadow-2xl bg-gray-900">
                            ...
                            >
                                ...
                                <a href="{{ asset('videos/ESTE SI.mp4') }}" class="text-blue-400 underline">Descargar video</a>
                            </video>
                        </div>
                    </div>
                    ...
                    <div class="prose prose-lg max-w-none text-gray-700">
                        <p class="mb-6"><strong>Brindamos orientación especializada y elaboración de informes legales exhaustivos para atender denuncias contra funcionarios de la institución.</strong></p>
                        ...
                        <ul class="space-y-3 mb-6">
                            <li class="flex items-start">
                                ...
                                <span>Análisis detallado de la situación y antecedentes</span>
                            </li>
                            <li class="flex items-start">
                                <svg class="w-6 h-6 mt-1 mr-3 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20" style="color: #1C6AB0;">
                                    <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"></path>
                                </svg>
                                <span>Evaluación de la procedencia legal de denuncias</span>
                            </li>
                            <li class="flex items-start">
                                <svg class="w-6 h-6 mt-1 mr-3 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20" style="color: #1C6AB0;">
                                    <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"></path>
                            ...
                            <li class="flex items-start">
                                ...
                                <span>Asesoramiento en la respuesta institucional</span>
                            </li>
                            <li class="flex items-start">
                                <svg class="w-6 h-6 mt-1 mr-3 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20" style="color: #1C6AB0;">
                                    <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"></path>
                                </svg>
                                <span>Estrategias de mitigación de riesgos</span>
                            </li>
                            <li class="flex items-start">
                                <svg class="w-6 h-6 mt-1 mr-3 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20" style="color: #1C6AB0;">
                                    <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"></path>
                        ...
                        <p class="text-base leading-relaxed"><strong>Protegemos los intereses de la institución con fundamentos legales sólidos y estrategias efectivas.</strong></p>
                    </div>
