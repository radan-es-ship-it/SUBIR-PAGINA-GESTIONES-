            ...
            <div class="bg-white rounded-2xl shadow-xl overflow-hidden" data-aos="fade-up">
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-0">
                    <div class="order-2 lg:order-1">
                        ...
                        <p class="text-gray-600 mb-6">Asesoramiento integral en seguridad ocupacional</p>
                    ...
                    <div class="order-2 p-8 lg:p-12 flex flex-col justify-center">
                        <div class="prose prose-lg max-w-none text-gray-700">
                            <p class="mb-6"><strong>Asesoramiento integral en materia de Seguridad e Higiene Ocupacional para garantizar ambientes laborales seguros.</strong></p>
                            ...
                            <ul class="space-y-3 mb-6">
                                <li class="flex items-start">
                                    ...
                                    <span>Evaluación de condiciones de trabajo</span>
                                </li>
                                <li class="flex items-start">
                                    <svg class="w-6 h-6 mt-1 mr-3 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20" style="color: #1C6AB0;">
                                        <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"></path>
                                    </svg>
                                    <span>Implementación de medidas preventivas</span>
                                </li>
                                <li class="flex items-start">
                                    <svg class="w-6 h-6 mt-1 mr-3 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20" style="color: #1C6AB0;">
                                        <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"></path>
                                    </svg>
                                    <span>Elaboración de protocolos de seguridad</span>
                                </li>
                                <li class="flex items-start">
                                    <svg class="w-6 h-6 mt-1 mr-3 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20" style="color: #1C6AB0;">
                                        <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"></path>
                                    </svg>
                                    <span>Capacitación en prevención de riesgos</span>
                                </li>
                                <li class="flex items-start">
                                    <svg class="w-6 h-6 mt-1 mr-3 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20" style="color: #1C6AB0;">
                                        <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"></path>
                                ...
                                <li class="flex items-start">
                                    ...
                                    <span>Gestión de emergencias</span>
                                </li>
                                <li class="flex items-start">
                                    <svg class="w-6 h-6 mt-1 mr-3 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20" style="color: #1C6AB0;">
                                        <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"></path>
                                    </svg>
                                    <span>Planes de mejora continua</span>
                                </li>
                            </ul>

                            <p class="text-base leading-relaxed"><strong>Protegemos la salud de sus trabajadores y aseguramos el cumplimiento de todas las disposiciones legales.</strong></p>
                        </div>
                        <div class="mt-8">
